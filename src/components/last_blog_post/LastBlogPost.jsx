...
export default function LastBlogPost({fromHome, clipped, post_id, title, date, titleImg, titleParagraph}) {
	const articleLink = post_id + '_' + title.toLowerCase().split(' ').join('_');

	return (
		<div className={`last_blog_post ${clipped ? 'clipped': ''}`} data-post-id={post_id}>
