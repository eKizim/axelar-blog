...
export default function NewsSection() {
    const renderNews = newsBase.map(el => el = <NewsItem key={el.news_item_id} fromHome news_item_id={el.news_item_id} title={el.title} date={el.date} titleImg={el.title_img}/>);
