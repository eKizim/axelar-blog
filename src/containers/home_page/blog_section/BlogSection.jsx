...
export default function BlogSection() {
    ...
    const renderRecentPosts = recentPosts.map(el => el = <BlogPost key={el.post_id} fromHome clipped post_id={el.post_id} titleImg={el.title_img} date={el.date} title={el.title} titleParagraph={el.title_p}/>);
